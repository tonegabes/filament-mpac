...
final class BaseIconsProvider extends ServiceProvider
{
    public function register(): void
    {
        FilamentIcon::register([
            ...
            PanelsIconAlias::PAGES_DASHBOARD_NAVIGATION_ITEM                               => Phosphor::HouseLine,
            ...
            PanelsIconAlias::SIDEBAR_COLLAPSE_BUTTON                                       => Phosphor::List,
            PanelsIconAlias::SIDEBAR_COLLAPSE_BUTTON_RTL                                   => Phosphor::CaretRight,
            PanelsIconAlias::SIDEBAR_EXPAND_BUTTON                                         => Phosphor::ListPlus,
